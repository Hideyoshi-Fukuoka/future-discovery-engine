...
const InitiationConsole = ({ onStart }) => {
    ...
    return (
        <div className="w-full max-w-2xl font-mono flex flex-col items-center justify-center min-h-[50vh]">
            <div className="mb-12 text-center">
                <h1 className="text-4xl md:text-5xl text-cyan-400 mb-6 tracking-widest font-bold">
                    未来発見エンジン
                </h1>
                <p className="text-cyan-600 tracking-[0.3em] text-sm animate-pulse">
            ...
            <button
                ...
                disabled={isBooting}
                className={`
                    relative group px-12 py-4 border border-cyan-500/50 bg-cyan-950/30
            ...
            <div className="mt-16 text-xs text-cyan-800/80 tracking-widest text-center space-y-2">
